...
if($debug) {
    // Debug dump for query string
    print_r("URI:  ".$uri."\n");
    print_r("Query String:  ".$query_str."\n");
...
if($debug) {
    print_r("Country Code: ".$code."\n");
    print_r("Full Country Name: ".$fullName."\n");
}
...
if($debug) {
    // output the final url used for our API call
    print_r($url."\n");
    echo "\n";
}
